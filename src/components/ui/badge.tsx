...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-medium tracking-tight transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-zinc-800 text-zinc-100 shadow hover:bg-zinc-800/80",
        secondary:
          "border-transparent bg-zinc-100 text-secondary-foreground animate hover:bg-zinc-200/80",
        destructive:
